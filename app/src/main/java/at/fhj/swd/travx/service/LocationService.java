package at.fhj.swd.travx.service;
...
import at.fhj.swd.travx.TrevXApplication;
import at.fhj.swd.travx.ui.BillCaptureActivity;
...
public class LocationService extends Service {
    ...
    public void onCreate() {
        ...
        notification = new NotificationCompat.Builder(this, TrevXApplication.CHANNEL_ID)
                .setContentTitle("TrevX Location Service")
                .setContentText("Updating location")
                .setSmallIcon(R.drawable.ic_searching_24dp)
